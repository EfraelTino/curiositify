...
<body  cz-shortcut-listen="true">
    ...
    <div style="
          ...
          filter: invert(1);
        "></div>
    <section class="container flex justify-center relative z-10">
        <div class="row container p-3 rounded-lg border bg-card bg-white text-card-foreground shadow-sm w-full max-w-6xl my-16 p-4">
            <div class="col-12">
                <div class="row">
                    <!-- PHOTO PROFILE -->
                    <div class="col-12">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-12 col-md-6 col-lg-4 align-items-center" id="choose-item">
                                            <div class="flex flex-col space-y-2">
                                                <div>
                                                    <h3 class="font-semibold tracking-tight text-2xl text-black">Nombre del usuario</h3>
                ...
                <div class="row">
                    <div class="col-12">
                        <form enctype="multipart/form-data" class="grid grid-cols-12 gap-6">
