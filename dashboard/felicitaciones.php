...
// Verifica si hay datos en $get_completed y si el curso ya está terminado
        ...
        <div class="container d-flex justify-content-center align-items-center h-100 ">
            <div class="rounded-lg border bg-card text-card-foreground shadow-sm p-6">
                <div class="row d-flex justify-content-center m-2 m-sm-4 m-md-5">
                    ...
                    <div class="row mt-3">
                        <div class="col-12 d-flex justify-content-center">
                            <a class="inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-base  font-normal ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-black focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 bg-[#F3C623] text-black hover:bg-opacity-80 h-10 px-4 py- 2" href="./courses.php">Continuar aprendiendo <svg
