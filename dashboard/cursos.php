...
<body>
    ...
    <main class="relative z-10">
        ...
        <section class="!visible transition-opacity duration-150  text-foreground !opacity-100 text-black">
                    ...
                    <div class="col-12">
                        <div class="row w-100  bg- mb-4 p-2">
                            <div class="col-12">
                                <div class="row">
                                    <div class="col-6">
                                        <h2 class="text-2xl font-bold mb-5 text-black">
                                            Cursos registrados</h2>

                                    </div>
                                    <div class="col-6">
                                        <div class="flex  justify-end gap-4 mb-0">
                                            <div class="">
                                                <a class="inline-flex bg-black  items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 bg-primary text-primary-foreground hover:bg-opacity-60 h-10 px-4 py-2"
                                            ...
                                            <div class="">
                                                <a class="inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-black focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 bg-[#F3C623] text-black hover:bg-opacity-80 h-10 px-4 py-2"
                                                    href="./addanuncio.php">Nuevo anuncio
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20"
                                ...
                                <div class="grid grid-cols-1 mt-3 border rounded-lg shadow-lg bg-white">
                                    <div class="relative w-full overflow-auto col-span-1">
                                        <table class="w-full caption-bottom text-sm">
                                            ...
                                            <tbody>
                                                ...
                                                ?>
                                                            <tr class="border-b transition-colors hover:bg-muted/50 data-[state=selected]:bg-muted">
                                                                <th class="p-4 align-middle text-black font-medium">
                                                                    <?php echo $pos; ?>
                                                                </th>
                                                                <td class="p-4 align-middle text-black font-medium">
                                                                    <figure class="p-4 align-middle text-black">
                                                                ...
                                                                <td class="p-4 align-middle text-black font-medium">
                                                                    <p class="titulo-curso p-4 align-middle text-black">
                                                                        <?php echo $fila['titulo_curso']; ?>
                                                                    </p>

                                                                </td>
                                                                <td class="p-4 align-middle text-black font-medium">
                                                                    <p class="p-4 align-middle text-black" id="estadoCurso-<?php echo $fila['id'] ?>">
